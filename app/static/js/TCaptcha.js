!function (t) {
    ...
    "use strict";
    var o = function () {
        var t = 1, e = /subsid=(\d+)/.exec(location.href);
    ...
    "use strict";
    var o = Object.prototype.hasOwnProperty, r = Object.prototype.toString, i = Object.defineProperty,
        a = Object.getOwnPropertyDescriptor, c = function (t) {
    ...
    t.exports = function f() {
        var t, e, n, o, r, i, a = arguments[0], l = 1, d = arguments.length, h = !1;
        for ("boolean" == typeof a && (h = a, a = arguments[1] || {}, l = 2), (null == a || "object" != typeof a && "function" != typeof a) && (a = {}); l < d; ++l) if (null != (t = arguments[l])) for (e in t) n = p(a, e), a !== (o = p(t, e)) && (h && o && (s(o) || (r = c(o))) ? (r ? (r = !1, i = n && c(n) ? n : []) : i = n && s(n) ? n : {}, u(a, {
            name: e,
            newValue: f(h, i, o)
        })) : void 0 !== o && u(a, {name: e, newValue: o}));
        return a
    }
}, function (t, e, n) {
    "use strict";
    ...
    function f() {
        var t = document.createElement("style"), e = i();
    ...
    function l(t, e) {
        ...
        } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (s = document.createElement("link"), u = i(), s.rel = "stylesheet", u.appendChild(s), o = p(m, null, n = s), r = function () {
    ...
    function y(t, e, n, o) {
        var r = n ? "" : o.css;
        if (t.styleSheet) t.styleSheet.cssText = h(e, r); else {
    ...
    "object" !== ("undefined" == typeof JSON ? "undefined" : _typeof(JSON)) && (JSON = {}), function () {
        ...
        function str(t, e) {
            ...
            switch (s && "object" === (void 0 === s ? "undefined" : _typeof(s)) && "function" == typeof s.toJSON && (s = s.toJSON(t)), "function" == typeof rep && (s = rep.call(e, t, s)), void 0 === s ? "undefined" : _typeof(s)) {
                ...
                case"object":
                    ...
                    if (rep && "object" === (void 0 === rep ? "undefined" : _typeof(rep))) for (i = rep.length, n = 0; n < i; n += 1) "string" == typeof rep[n] && (r = str(o = rep[n], s)) && a.push(quote(o) + (gap ? ": " : ":") + r); else for (o in s) Object.prototype.hasOwnProperty.call(s, o) && (r = str(o, s)) && a.push(quote(o) + (gap ? ": " : ":") + r);
                    return r = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + c + "}" : "{" + a.join(",") + "}", gap = c, r
            }
        }
        ...
        "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function () {
            ...
            function walk(t, e) {
                var n, o, r = t[e];
                if (r && "object" === (void 0 === r ? "undefined" : _typeof(r))) for (n in r) Object.prototype.hasOwnProperty.call(r, n) && ((o = walk(r, n)) !== undefined ? r[n] = o : delete r[n]);
    ...
    var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
    }, r = "[CODE_VERIFY]", i = "postMessage" in window;
    ...
    var Messenger = __webpack_require__(15), domReady = __webpack_require__(34),
        btoa = window.btoa || __webpack_require__(35), extend = Object.assign || __webpack_require__(2),
        loadScript = __webpack_require__(36), eventListener = __webpack_require__(5),
        Executor = __webpack_require__(37), isIEVar = __webpack_require__(38), isElement = __webpack_require__(39),
        ...
        capDomain = "https://ssl.captcha.qq.com", cdnDomain = "https://captcha.gtimg.com/1",
        mobileFrameJs = "/TCaptchaFrame_m.88ec788b.js", pcFrameJs = "/TCapIframe.js?v=" + (new Date).getTime(),
        grayscaleFrameJs = "/tcaptcha-frame.1b406056.js", autoFrameJs = isMobile ? mobileFrameJs : pcFrameJs,
        grayscaleThreshold = 1,
        grayscaleAppId = ["123", "2100049389", "2100049390", "2046103261", "2070173641", "2060075756"],
        grayscaleProb = Math.random(), needGrayscaleJs = void 0, jsLoadStatus = "none",
        capError = __webpack_require__(3), preVerifyData = {}, capObj = void 0, initQueue = [], defaultOpt = {
            type: "popup",
            ...
            for (var e = 0, n = grayscaleAppId.length; e < n; e++) if (t == grayscaleAppId[e]) return needGrayscaleJs = !0;
        ...
        }, 0), Captcha = function Captcha($btn, appid, _tcallback_, opts) {
            var bizState = void 0;
            if (isElement($btn)) if (appid && "object" === (void 0 === appid ? "undefined" : _typeof(appid))) opts = appid, appid = null, _tcallback_ = null; else {
    ...
    Captcha.prototype = {
        show: function () {
            if (executor.isDone) this.__show__(); else {
                for (var t = 0; t < initQueue.length; t++) if (initQueue[t] === this) return;
                initQueue.push(this)
            }
        }, __show__: function () {
            var t = this.initOpts;
            ...
            if (this.initOpts.forceLang) {
                var t = {"zh-cn": "2052", "zh-hk": "1028", en: "1033"}, e = this.initOpts.forceLang;
    ...
    "use strict";
    var o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = function (t) {
    ...
    t.exports = function r(t, e, n, i, a, c, s) {
        s = s || 1;
        var u = !1, p = document.createElement("script");

        function f(t) {
            u || (t && "load" === t.type || /^(loaded|complete)$/.test(this.readyState)) && (i() ? (u = !0, a && a()) : l())
        }
